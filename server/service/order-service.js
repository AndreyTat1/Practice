...
class OrderService {
    async createOrder( dispatcherId, driverId) {
    
        const order = await OrderModel.create({  dispatcherId, driverId});
        const orderDto = new OrderDto(order);
    
        return {  dispatcherId: orderDto.dispatcherId, driverId: orderDto.driverId};
    }
